...
t.prototype.video = function() {
cc.director.once("fail", function() {
r.default.showTip("暂无视屏");
});
cc.director.once("reward", function() {
r.default.showTip("成功");
});
jsb.reflection.callStaticMethod("BGAdManager", "showRewardVideoAd");
};
t.prototype.bannershow = function() {
jsb.reflection.callStaticMethod("BGAdManager", "showBannerAd");
};
t.prototype.bannerhide = function() {
jsb.reflection.callStaticMethod("BGAdManager", "hideBannerAd");
};
